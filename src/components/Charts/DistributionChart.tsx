...
const PIE_COLORS = [
  PALETTE.presentes.solid,
  PALETTE.faltas.solid,
...
const CustomTooltip = ({ active, payload }: any) => {
  ...
  const colorKey = entry.name === 'Presentes'
    ? 'presentes'
    : entry.name === 'Faltas'
      ? 'faltas'
      : 'outros';
  ...
  return (
    <div style={{
      ...
      <span style={{ fontWeight: 700, color: pal.text, fontSize: '13px' }}>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <span style={{ fontSize: '14px', fontWeight: 700, color: '#1e293b', letterSpacing: '-0.01em' }}>
            Distribuição do Dia
          </span>
